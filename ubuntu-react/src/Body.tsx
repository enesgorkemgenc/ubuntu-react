...
function Body() {
    return (
        <div id="ubuntu-body" className="flex w-full flex-1 flex-row">
            ...
            >
                <div className="h-150 w-240 flex border-collapse flex-row overflow-hidden rounded-xl border-2 border-gray-300 bg-white shadow-lg">
                    <div className="tabs-section gap flex w-1/4 flex-col border-r-2 border-r-gray-200">
                        ...
                        <div
                            className="flex w-full flex-1 flex-col overflow-y-auto px-1 text-sm
                            font-light
                        ...
                        >
                            <div className="flex w-full flex-col gap-1 py-2.5">
                                <div className="flex h-10 w-full flex-row items-center justify-start gap-3.5 rounded-md px-4 transition-colors duration-75 hover:bg-black/5">
                                    <span>Z</span>
                                    <span>Network</span>
                                </div>
                                <div className="flex h-10 w-full flex-row items-center justify-start gap-3.5 rounded-md px-4 transition-colors duration-75 hover:bg-black/5">
